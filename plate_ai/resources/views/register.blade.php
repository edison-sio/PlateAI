<x-layout>
    <div class="h-screen w-screen flex flex-col justify-center items-center">
        <form action="/register" method="post" class="flex flex-col justify-center items-center gap-3 w-1/4">
            <label class="card-title">Register</label>
            ...
            <div class="w-full flex flex-col gap-3">
                ...
                <a href={{ route('login') }} class="flex-auto">Already have an account?</a>
            </div>
        </form>
